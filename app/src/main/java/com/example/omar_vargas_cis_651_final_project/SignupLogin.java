...
public class SignupLogin extends AppCompatActivity {
    ...
    private void saveUserDataToDB() {
        ...
        usersRef.child(currentUser.getUid()).setValue(new User(displayName.getText().toString(), email.getText().toString(), phoneNumber.getText().toString()));
    }
    ...
    public void Signup(View view) {
        ...
        if (email.getText().toString().equals("") || password.getText().toString().equals("") ||
            ...
            return;//test jose ok add commit
        }
        mAuth.signInWithEmailAndPassword(email.getText().toString(), password.getText().toString())
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Log.d("SignupLogin", e.getMessage());
                Toast.makeText(SignupLogin.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void SendEmailVerification(View view) {
        if (mAuth.getCurrentUser()!=null) {
            Toast.makeText(this, "Please login first to resend the verification email.", Toast.LENGTH_SHORT).show();
            return;
        }
        currentUser.sendEmailVerification().addOnSuccessListener(SignupLogin.this, new OnSuccessListener<Void>() {
            @Override
