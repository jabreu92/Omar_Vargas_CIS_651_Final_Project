...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.ViewHolder> {
    ...
    private class UserModel {
        ...
        public UserModel(String uid, String description, String url, String date, String postKey) {
            this.uid = uid;
    ...
    public MyRecyclerAdapter(RecyclerView recyclerView) {
        ...
        usersRefListener = usersRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Log.d("Final Project Test",dataSnapshot.toString());
                UserModel userModel = new UserModel(dataSnapshot.child("author").getValue().toString(),
                        dataSnapshot.child("description").getValue().toString(), dataSnapshot.child("url").getValue().toString(),
                        localDateFormat.format(new Date(Long.parseLong(dataSnapshot.child("timestamp").getValue().toString()))), dataSnapshot.getKey());
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.uref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                holder.phone_v.setText("Phone Number: " + dataSnapshot.child("phone").getValue().toString());
        ...
        holder.likesRefListener = holder.likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getValue().toString().equals("true")) {
                    ...
                    holder.likeBtn.setImageDrawable(ContextCompat.getDrawable(r.getContext(), R.drawable.like_inactive));
                }
            }
